  ...
  <v-row align="center" justify="center">
    <v-col class="mt-0" cols="12" sm="8" md="4">
      <v-card class="elevation-12" color>
        ...
        <v-card-text>
          <v-form>
            <v-text-field label="Nombre" name="nombre" type="text" color="green accent-3"></v-text-field>

            <v-text-field label="Apellido" name="apellido" type="text" color="green accent-3"></v-text-field>
        ...
        <v-card-text class="white--text pt-0">¿Ya tienes una cuenta?</v-card-text>
      </v-card>
    </v-col>
  </v-row>
</template>
...
export default {
  ...
  data: () => ({
    icons: ["mdi-facebook-box", "mdi-google"]
  })
};
</script>
