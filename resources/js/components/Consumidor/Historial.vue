            ...
            <v-container>
              <v-row>
                <v-col cols="12" md="12" xs="12" style="display: flex;align-items: center;">
                  ...
                  <v-toolbar-title class="headline" style="font-size: 1.6rem">Historial de Listas de Compras</v-toolbar-title>
                  </v-toolbar>  
                </v-col>
              </v-row>
              <v-row>
                ...
                <template v-slot:activator="{ on, attrs }">
                 ...
                 <v-date-picker color="green accent-2" v-model="date" locale="es-419" @input="menu2 = false">
                </v-date-picker>
                </v-menu>   
                  <v-divider class="mx-4" inset vertical></v-divider>
                </v-col>
