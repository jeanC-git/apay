      ...
      <v-row v-if="arrayProductos.length>0" class="d-flex justify-start">
        <v-col cols="12" md="3" sm="6" v-for="producto in arrayProductos" :key="producto.id">
          <v-card width="100%" class="mx-auto" color="green accent-3">
            ...
            <v-img :src="producto.foto" height="100"></v-img>
            <v-card-text>
          ...
          <v-list three-line subheader>
            <v-list>
              ...
              <v-list-item-group color="primary">
                <v-list-item v-for="producto_lista in carrito_compras" :key="producto_lista.id">
                  <v-btn style="border:1px solid" icon @click="producto_lista.cantidad++ ">
